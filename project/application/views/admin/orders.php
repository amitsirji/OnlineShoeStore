                  ...
                  <?php foreach($orders as $order)
				  {
			        ...
			        <tr>
					 ...
					 if($order->order_status=='new')
			          ...
			          <td><a href="<?php echo base_url();?>index.php/admin/view_order/<?php echo $order->order_id;?>">View</a>
                      <?php if($order->order_status=='new') { ?>
					  | <a href="<?php echo base_url();?>index.php/admin/cancel_order/<?php echo $order->order_id;?>">Cancel Order</a>
                                          | <a href="<?php echo base_url();?>index.php/admin/dispatch_order/<?php echo $order->order_id;?>">Mark as Dispatched</a>
                      <?php } ?>
                      </td>
		            </tr>
                    <?php }?>
							...
							<?php for($i=1; $i<=$pages;$i++)
                                                        {
                                                            ...
                                                            echo base_url();?>index.php/admin/orders/<?php echo $i;?>"><?php echo $i;?></a>
