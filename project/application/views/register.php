...
<body>
	<div id="wrapper">
			...
			<div id="content">
				...
				<div id="right">
					<h1 class="bar">Register to shoes.</h1>
		  ...
		  <form action="<?php echo base_url();?>index.php/register" method="post" enctype="multipart/form-data" id="admin">
			<p>
			  <label>Full Name:</label>
				<input name="full_name" type="text" id="full_name" value="<?php echo set_value('full_name');?>"> 
			  </p>
						<p>
			...
			<p>
			  <label>Company Name (If trade account):</label>
				<input name="company_name" type="text" id="company_name" value="<?php echo set_value('company_name');?>"> 
			  </p>
			<p>
			...
			<p>
			  <label>Password</label>
				<input name="password" type="password" id="password" value="<?php echo set_value('password');?>"> 
			  </p>		
			<p>
			  <label>Confirm Password:</label>
				<input name="password2" type="password" id="password2" value="<?php echo set_value('password2');?>"> 
