			...
			<div id="content">
				...
				<div id="right">
					...
					<form action="<?php echo base_url();?>index.php/front/order_step2" method="post" enctype="multipart/form-data" id="admin">
						...
						<p>
							<label>Address:</label>
							<input name="address1" type="text" id="address1" value="<?php echo set_value('address1');?>"> 
							<input name="address2" type="text" id="address2" value="<?php echo set_value('address2');?>"> 
						</p>
						<p>
						...
						<p>
							...
							<input name="post_code" type="text" id="post_code" value="<?php echo set_value('post_code');?>"> 
						</p>
					<br />
					<h2>Order Summary</h2>
                    <?php
					...
					<input name="vat" type="hidden" id="vat" value="<?php echo $vat;?>" />
                    <input name="sub_total" type="hidden" id="sub_total" value="<?php echo $total_price;?>" />
                    <input name="total_price" type="hidden" id="total_price" value="<?php echo $total_price+$vat;?>" />
