		  ...
		  <form action="<?php echo base_url();?>index.php/user/account" method="post" enctype="multipart/form-data" id="admin">
			<p>
			  <label>Full Name:</label>
				<input name="full_name" type="text" id="full_name" value="<?php echo $this->session->userdata('full_name');?>"> 
			  </p>
						<p>
			...
			<p>
			  <label>Company Name (If trade account):</label>
				<input name="company_name" type="text" id="company_name" value="<?php echo $this->session->userdata('company_name');?>"> 
			  </p>

			<p>
			  <label>Email Address</label>
				<input name="email" type="text" id="email" value="<?php echo $this->session->userdata('email');?>"> 
			  </p>
			<p>
